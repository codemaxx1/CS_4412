...
/*
	test the priority queue created in Priority_Queue.h
*/
...
int main()
{
    ...
    //extract the min
   	cout << "\n\ntest extracting the smallest value.";
	pQInstance -> extractMin();
	
	
	//print the queue now that we have extracted the smallest value
	pQInstance -> printQueue();
